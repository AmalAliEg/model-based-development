###########################################################################
## Makefile generated for component 'triggered'. 
## 
## Makefile     : triggered.mk
## Generated on : Mon Jan 13 17:16:21 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\triggered.exe
...
COMPILER_COMMAND_FILE     = triggered_comp.rsp
CMD_FILE                  = triggered.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\triggered.exe
...
DEFINES_STANDARD = -DMODEL=triggered -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\triggered_ert_rtw\triggered.c

MAIN_SRC = $(START_DIR)\triggered_ert_rtw\ert_main.c
...
{$(START_DIR)\triggered_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\triggered_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\triggered_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\triggered_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\triggered_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\triggered_ert_rtw\ert_main.c"


triggered.obj : "$(START_DIR)\triggered_ert_rtw\triggered.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\triggered_ert_rtw\triggered.c"
