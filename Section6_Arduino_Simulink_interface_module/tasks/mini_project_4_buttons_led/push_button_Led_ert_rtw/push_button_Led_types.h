...
#ifndef push_button_Led_types_h_
#define push_button_Led_types_h_
#include "rtwtypes.h"
...
typedef struct P_IfActionSubsystem_push_butt_T_ P_IfActionSubsystem_push_butt_T;

/* Parameters (default storage) */
typedef struct P_push_button_Led_T_ P_push_button_Led_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_push_button_Led_T RT_MODEL_push_button_Led_T;

#endif                                 /* push_button_Led_types_h_ */
