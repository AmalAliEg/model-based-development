###########################################################################
## Makefile generated for component 'push_button'. 
## 
## Makefile     : push_button.mk
## Generated on : Sat Nov 23 07:19:21 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/push_button.elf
...
PRODUCT_NAME              = push_button
MAKEFILE                  = push_button.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/DELL/Desktop/model-based-design/Section6_Arduino_Simulink_interface_module/tasks/min_project_3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/push_button.elf
...
DEFINES_STANDARD = -DMODEL=push_button -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o xcp_ext_mode.o push_button.o push_button_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/push_button_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/push_button_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/push_button_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/push_button_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


push_button.o : $(START_DIR)/push_button_ert_rtw/push_button.c
	$(CC) $(CFLAGS) -o "$@" "$<"


push_button_data.o : $(START_DIR)/push_button_ert_rtw/push_button_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
