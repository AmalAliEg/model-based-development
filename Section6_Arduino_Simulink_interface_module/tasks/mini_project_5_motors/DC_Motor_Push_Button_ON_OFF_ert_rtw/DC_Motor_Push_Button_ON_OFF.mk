###########################################################################
## Makefile generated for component 'DC_Motor_Push_Button_ON_OFF'. 
## 
## Makefile     : DC_Motor_Push_Button_ON_OFF.mk
## Generated on : Wed Nov 27 06:41:40 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DC_Motor_Push_Button_ON_OFF.elf
...
PRODUCT_NAME              = DC_Motor_Push_Button_ON_OFF
MAKEFILE                  = DC_Motor_Push_Button_ON_OFF.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DC_Motor_Push_Button_ON_OFF.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~1/include -I$(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/standard -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/SCHEDU~1/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include
...
DEFINES_STANDARD = -DMODEL=DC_Motor_Push_Button_ON_OFF -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/DC_Motor_Push_Button_ON_OFF.c $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/DC_Motor_Push_Button_ON_OFF_data.c C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/scheduler/src/arduinoAVRScheduler.cpp

MAIN_SRC = $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/ert_main.c
...
OBJS = MW_arduino_digitalio.o DC_Motor_Push_Button_ON_OFF.o DC_Motor_Push_Button_ON_OFF_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DC_Motor_Push_Button_ON_OFF.o : $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/DC_Motor_Push_Button_ON_OFF.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DC_Motor_Push_Button_ON_OFF_data.o : $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/DC_Motor_Push_Button_ON_OFF_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/DC_Motor_Push_Button_ON_OFF_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
