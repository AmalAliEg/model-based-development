/*
 * File: DC_Motor_Push_Button_ON_OFF_types.h
 *
...
#ifndef DC_Motor_Push_Button_ON_OFF_types_h_
#define DC_Motor_Push_Button_ON_OFF_types_h_
#include "rtwtypes.h"
...
typedef struct tag_HaWnjzA2iiR2NMKNB2VNI codertarget_arduinobase_blo_j_T;

#endif                             /* typedef_codertarget_arduinobase_blo_j_T */

/* Parameters (default storage) */
typedef struct P_DC_Motor_Push_Button_ON_OFF_T_ P_DC_Motor_Push_Button_ON_OFF_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_DC_Motor_Push_Button__T RT_MODEL_DC_Motor_Push_Button_T;

#endif                                /* DC_Motor_Push_Button_ON_OFF_types_h_ */
