###########################################################################
## Makefile generated for component 'mini_project_2'. 
## 
## Makefile     : mini_project_2.mk
## Generated on : Sat Nov 23 05:52:34 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mini_project_2.elf
...
PRODUCT_NAME              = mini_project_2
MAKEFILE                  = mini_project_2.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/DELL/Desktop/model-based-design/Section6_Arduino_Simulink_interface_module/tasks/mini_project_2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mini_project_2.elf
...
DEFINES_STANDARD = -DMODEL=mini_project_2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o mini_project_2.o mini_project_2_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/mini_project_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/mini_project_2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/mini_project_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/mini_project_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mini_project_2.o : $(START_DIR)/mini_project_2_ert_rtw/mini_project_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mini_project_2_data.o : $(START_DIR)/mini_project_2_ert_rtw/mini_project_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/mini_project_2_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/mini_project_2_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/mini_project_2_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
