/*
 * File: DC_Motor_control_speed_Direction_Push_Button_types.h
 *
...
#ifndef DC_Motor_control_speed_Direction_Push_Button_types_h_
#define DC_Motor_control_speed_Direction_Push_Button_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
typedef struct tag_HaWnjzA2iiR2NMKNB2VNI codertarget_arduinobase_blo_k_T;

#endif                             /* typedef_codertarget_arduinobase_blo_k_T */

/* Parameters for system: '<Root>/motor energized' */
typedef struct P_motorenergized_DC_Motor_con_T_ P_motorenergized_DC_Motor_con_T;

/* Parameters (default storage) */
typedef struct P_DC_Motor_control_speed_Dire_T_ P_DC_Motor_control_speed_Dire_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_DC_Motor_control_spee_T RT_MODEL_DC_Motor_control_spe_T;

#endif               /* DC_Motor_control_speed_Direction_Push_Button_types_h_ */
