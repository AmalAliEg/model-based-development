###########################################################################
## Makefile generated for component 'DC_Motor_control_speed_Direction_Push_Button'. 
## 
## Makefile     : DC_Motor_control_speed_Direction_Push_Button.mk
## Generated on : Tue Nov 26 07:25:29 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DC_Motor_control_speed_Direction_Push_Button.elf
...
PRODUCT_NAME              = DC_Motor_control_speed_Direction_Push_Button
MAKEFILE                  = DC_Motor_control_speed_Direction_Push_Button.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DC_Motor_control_speed_Direction_Push_Button.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~1/include -I$(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/standard -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/SCHEDU~1/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=2 -DMW_PRESCALAR=128 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=1 -DARDUINO_SERIAL_RECEIVE_BUFFER_SIZE=64 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -DMW_NUM_PINS=20 -D_RTT_PWM_BLOCKS_ -D_ONBOARD_EEPROM_SIZE_=1024
...
DEFINES_STANDARD = -DMODEL=DC_Motor_control_speed_Direction_Push_Button -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_arduino_digitalio.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/MW_PWMDriver.c $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/DC_Motor_control_speed_Direction_Push_Button.c $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/DC_Motor_control_speed_Direction_Push_Button_data.c $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/rtGetInf.c $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/rtGetNaN.c $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/rt_nonfinite.c C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp C:/ProgramData/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/arduinotarget/scheduler/src/arduinoAVRScheduler.cpp

MAIN_SRC = $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/ert_main.c
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o DC_Motor_control_speed_Direction_Push_Button.o DC_Motor_control_speed_Direction_Push_Button_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DC_Motor_control_speed_Direction_Push_Button.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/DC_Motor_control_speed_Direction_Push_Button.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DC_Motor_control_speed_Direction_Push_Button_data.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/DC_Motor_control_speed_Direction_Push_Button_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/DC_Motor_control_speed_Direction_Push_Button_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
