...
typedef struct {
  ...
  codertarget_arduinobase_blo_k_T obj_d;/* '<Root>/button status1' */
  codertarget_arduinobase_blo_k_T obj_dl;/* '<Root>/button status' */
 ...
 * '<S1>'   : 'DC_Motor_control_speed_Direction_Push_Button/motor energized'
 * '<S2>'   : 'DC_Motor_control_speed_Direction_Push_Button/motor energized1'
 */
