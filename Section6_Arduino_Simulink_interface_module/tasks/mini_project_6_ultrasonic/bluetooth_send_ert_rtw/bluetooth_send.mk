###########################################################################
## Makefile generated for component 'bluetooth_send'. 
## 
## Makefile     : bluetooth_send.mk
## Generated on : Fri Nov 29 00:34:45 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/bluetooth_send.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/bluetooth_send.elf
...
DEFINES_STANDARD = -DMODEL=bluetooth_send -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o bluetooth_send.o bluetooth_send_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/bluetooth_send_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/bluetooth_send_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/bluetooth_send_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
bluetooth_send.o : $(START_DIR)/bluetooth_send_ert_rtw/bluetooth_send.c
	$(CC) $(CFLAGS) -o "$@" "$<"


bluetooth_send_data.o : $(START_DIR)/bluetooth_send_ert_rtw/bluetooth_send_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/bluetooth_send_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
