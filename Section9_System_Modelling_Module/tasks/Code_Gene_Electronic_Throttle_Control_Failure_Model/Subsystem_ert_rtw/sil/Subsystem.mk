...
## Generated on : Fri Jan 03 02:49:35 2025
## Final product: .\Subsystem.exe
...
MODELREF_LIBS = ..\Subsystem.obj

LIBS = $(START_DIR)\Subsystem_ert_rtw\coderassumptions\lib\Subsystem_ca.lib
...
xil_interface.obj : "$(START_DIR)\Subsystem_ert_rtw\sil\xil_interface.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Subsystem_ert_rtw\sil\xil_interface.c"


sil_main.obj : "$(START_DIR)\Subsystem_ert_rtw\sil\sil_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Subsystem_ert_rtw\sil\sil_main.c"
