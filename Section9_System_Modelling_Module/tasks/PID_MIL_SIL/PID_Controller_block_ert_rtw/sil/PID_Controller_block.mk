###########################################################################
## Makefile generated for component 'PID_Controller_block'. 
## 
## Makefile     : PID_Controller_block.mk
## Generated on : Wed Jan 08 12:41:01 2025
## Final product: .\PID_Controller_block.exe
...
PRODUCT_NAME              = PID_Controller_block
MAKEFILE                  = PID_Controller_block.mk
...
MODELREF_LINK_RSPFILE     = PID_Controller_block_ref.rsp
COMPILER_COMMAND_FILE     = PID_Controller_block_comp.rsp
CMD_FILE                  = PID_Controller_block.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = .\PID_Controller_block.exe
...
DEFINES_STANDARD = -DMODEL=PID_Controller_block -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ..\PID_Controller_block.obj

LIBS = $(START_DIR)\PID_Controller_block_ert_rtw\coderassumptions\lib\PID_Controller_block_ca.lib
...
xil_interface.obj : "$(START_DIR)\PID_Controller_block_ert_rtw\sil\xil_interface.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Controller_block_ert_rtw\sil\xil_interface.c"


sil_main.obj : "$(START_DIR)\PID_Controller_block_ert_rtw\sil\sil_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Controller_block_ert_rtw\sil\sil_main.c"
