/*
 * PID_Controller_block_sbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: PID_Controller_block
 * Component Simulink Path: PID_Controller_block
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                PID_Controller_block_sbs
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("PID_controller");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
